  ...
  return <main className={styles.page}>
    <Grid condensed><Column lg={16} md={8} sm={4}>
      ...
      <section className={styles.providerGrid}>
        {data.providers.length === 0 ? (<InlineNotification kind="info" title="No AI providers configured" subtitle="AI provider information will appear here when a provider is configured." hideCloseButton />) 
