...
public class AdminPlatformController {
    ...
    public AdminPlatformController(PlatformOverviewService overviewService) { this.overviewService = overviewService; }

    @GetMapping("/overview")
    PlatformOverviewResponse overview() { return overviewService.getOverview(); }
}
